...
proc sql;
    ...
    from WORK.Extracted_BreastDrugEpisode e
...
/* Show the index dates produced by the criteria above */
proc print data=ic2_sg_index noobs;
    format index_date date9.;
    title "IC2: earliest SG episode (index date) per patient";
run;
