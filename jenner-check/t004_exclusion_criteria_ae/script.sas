...
/* Show the final analytic cohort produced by the criteria above */
proc print data=final_cohort noobs;
    format index_date date9.;
    title "Final analytic cohort (hepatic-eligible, no pre-index AE)";
run;
